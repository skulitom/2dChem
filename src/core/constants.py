...
# Reaction constants
COLLISION_ANGLE_TOLERANCE = 60.0
...
# Physics Constants
BOND_FORCE_SCALE = 10.0
MIN_REACTION_VELOCITY = 0.0
MAX_REACTION_VELOCITY = 15.0
...
DRAG_FORCE_MULTIPLIER = 0.5  # Adjust this to control drag responsiveness
INTERACTION_MODES = {
    'CREATE': 'create',
    'DRAG': 'drag'
}
